INSERT OR REPLACE INTO `media_assets` (`id`,`school_id`,`owner_id`,`key`,`filename`,`content_type`,`size_bytes`,`kind`,`alt_text`,`created_at`,`updated_at`) SELECT 'cmf-module-1-3-double-spend-video',c.`school_id`,c.`owner_id`,'static:/media/faculty/module-1-3-digital-cash-problem.mp4','module-1-3-digital-cash-problem.mp4','video/mp4',1646640,'video','Neural-narrated visual lesson for Module 1.3 of Crypto Mastery.',1785481200000,1785481200000 FROM `courses` c WHERE c.`id`='cognizen-crypto-mastery-foundations-production';
...
--> statement-breakpoint
INSERT OR REPLACE INTO `media_assets` (`id`,`school_id`,`owner_id`,`key`,`filename`,`content_type`,`size_bytes`,`kind`,`alt_text`,`created_at`,`updated_at`) SELECT 'cmf-module-1-3-ancestry-video',c.`school_id`,c.`owner_id`,'static:/media/faculty/module-1-3-technical-ancestry.mp4','module-1-3-technical-ancestry.mp4','video/mp4',1785549,'video','Neural-narrated visual lesson for Module 1.3 of Crypto Mastery.',1785481200000,1785481200000 FROM `courses` c WHERE c.`id`='cognizen-crypto-mastery-foundations-production';
--> statement-breakpoint
...
--> statement-breakpoint
INSERT OR REPLACE INTO `media_assets` (`id`,`school_id`,`owner_id`,`key`,`filename`,`content_type`,`size_bytes`,`kind`,`alt_text`,`created_at`,`updated_at`) SELECT 'cmf-module-1-3-claims-video',c.`school_id`,c.`owner_id`,'static:/media/faculty/module-1-3-white-paper-claims.mp4','module-1-3-white-paper-claims.mp4','video/mp4',1610387,'video','Neural-narrated visual lesson for Module 1.3 of Crypto Mastery.',1785481200000,1785481200000 FROM `courses` c WHERE c.`id`='cognizen-crypto-mastery-foundations-production';
--> statement-breakpoint
