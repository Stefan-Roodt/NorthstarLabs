INSERT OR REPLACE INTO `media_assets` (`id`,`school_id`,`owner_id`,`key`,`filename`,`content_type`,`size_bytes`,`kind`,`alt_text`,`created_at`,`updated_at`) SELECT 'cmf-module-1-1-money-video',c.`school_id`,c.`owner_id`,'static:/media/faculty/module-1-1-three-jobs-of-money.mp4','module-1-1-three-jobs-of-money.mp4','video/mp4',1616909,'video','Narrated visual lesson for Module 1.1 of Crypto Mastery.',1785391200000,1785391200000 FROM `courses` c WHERE c.`id`='cognizen-crypto-mastery-foundations-production';
...
--> statement-breakpoint
INSERT OR REPLACE INTO `media_assets` (`id`,`school_id`,`owner_id`,`key`,`filename`,`content_type`,`size_bytes`,`kind`,`alt_text`,`created_at`,`updated_at`) SELECT 'cmf-module-1-1-ledgers-video',c.`school_id`,c.`owner_id`,'static:/media/faculty/module-1-1-digital-balances.mp4','module-1-1-digital-balances.mp4','video/mp4',1826611,'video','Narrated visual lesson for Module 1.1 of Crypto Mastery.',1785391200000,1785391200000 FROM `courses` c WHERE c.`id`='cognizen-crypto-mastery-foundations-production';
--> statement-breakpoint
...
--> statement-breakpoint
INSERT OR REPLACE INTO `media_assets` (`id`,`school_id`,`owner_id`,`key`,`filename`,`content_type`,`size_bytes`,`kind`,`alt_text`,`created_at`,`updated_at`) SELECT 'cmf-module-1-1-scarcity-video',c.`school_id`,c.`owner_id`,'static:/media/faculty/module-1-1-digital-scarcity.mp4','module-1-1-digital-scarcity.mp4','video/mp4',1700779,'video','Narrated visual lesson for Module 1.1 of Crypto Mastery.',1785391200000,1785391200000 FROM `courses` c WHERE c.`id`='cognizen-crypto-mastery-foundations-production';
--> statement-breakpoint
